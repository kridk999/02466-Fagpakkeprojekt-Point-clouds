...
# BSUB -o logs/gpu_%J_EUCLID_3.out
# BSUB -e logs/gpu_%J_EUCLID_3.err
# -- end of LSF options --
​
# nvidia-smi
...
​
python3 ./train.py --shape 'feature_shape' #--dataset teeth --x_train /work3/ziruoye/data/publication_v2.0.0_train_small --x_test /work3/ziruoye/data/publication_v2.0.0_test_small \
