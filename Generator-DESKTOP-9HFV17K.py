...
class FoldNet_Encoder(nn.Module):
    ...
    def forward(self, pts):
        ...
        global feature_shape                        #Added a global variable which is used when args.shape = 'feature_shape'
        feature_shape = x 
...
class FoldNet_Decoder(nn.Module):
    ...
    def build_grid(self, batch_size):
        ...
        elif self.shape == 'feature_shape':                     #This elif statement has been added by us for this project
